"""User question memory model — question-level MEMORIZE tracking."""
...
class UserQuestionMemory(Base):
    """Track per-question memory state for MEMORIZE scheduling.

    Same formula as UserTopicMemory / UserLessonMemory but at question granularity.
    """
